...
enum AVAchievs
{
    BG_AV_TIMED_ACHIEV_ALTERAC_BLITZ    = 9166,             // achiev id 226

    BG_AV_ACHIEV_CRIT_ALL_COUNTS_A1     = 3386,             // achiev id 225
    BG_AV_ACHIEV_CRIT_ALL_COUNTS_A2     = 3387,
    ...
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF4   = 1804,
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF5   = 1805,
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF6   = 1806,
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF7   = 1807,
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF8   = 1808,
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF9   = 1809,
    BG_AV_ACHIEV_CRIT_STORMPIKE_PERF10  = 1810,

    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF1   = 1811,             // achiev id 873
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF2   = 1812,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF3   = 1826,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF4   = 1813,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF5   = 1814,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF6   = 1815,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF7   = 1816,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF8   = 1817,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF9   = 1818,
    BG_AV_ACHIEV_CRIT_FROSTWOLF_PERF10  = 1819,
};
