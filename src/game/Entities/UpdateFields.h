...
enum EUnitFields
{
    ...
    UNIT_FIELD_CHANNEL_SPELL                  = OBJECT_END + 0x0010, // Size: 1, Type: INT, Flags: PUBLIC
    ...
    PLAYER_FIELD_LIFETIME_HONORABLE_KILLS     = UNIT_END + 0x0438, // Size: 1, Type: INT, Flags: PRIVATE - CUSTOM: Fixed typo from PLAYER_FIELD_LIFETIME_HONORBALE_KILLS
